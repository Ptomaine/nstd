...
namespace agg
{
    ...
    public:
        ...
        void scale_x(double s)        { m_matrix.eM11.value = int(s); m_matrix.eM11.fract = int(s*65536); }
        void scale_y(double s)        { m_matrix.eM22.value = int(s); m_matrix.eM22.fract = int(s*65536); }
